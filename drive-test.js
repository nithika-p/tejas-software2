   ...
   var st_type;
    ...
    $(document).ready(function(){
      ...
      $("#ping-size-2").click(function(){
           $("#ping-size-drop span").empty();
            ...
            ping_size=String(parseInt(document.getElementById("ping-size").value)*1000);
            alert(ping_size);
        });
      $("#ping-size-3").click(function(){
             $("#ping-size-drop span").empty();
             $("#ping-size-drop span").append( "   "+ $("#ping-size-3").text());
             ping_size=String(parseInt(document.getElementById("ping-size").value)*1000000);
             alert(ping_size);
         });
     ...
     $("#dl-ps-2").click(function(){
          $("#dl-ps-drop span").empty();
           ...
           dl_ps=String(parseInt(document.getElementById("st-size-dl").value)*1000);
           alert(dl_ps);
       });
     $("#dl-ps-3").click(function(){
            $("#dl-ps-drop span").empty();
            $("#dl-ps-drop span").append( "   "+ $("#dl-ps-3").text());
            dl_ps=String(parseInt(document.getElementById("st-size-dl").value)*1000000);
            alert(dl_ps);
     });
      ...
      $("#ul-ps-2").click(function(){
           $("#ul-ps-drop span").empty();
            ...
            ul_ps=String(parseInt(document.getElementById("st-size-ul").value)*1000);
            alert(ul_ps);
        });
      $("#ul-ps-3").click(function(){
             $("#ul-ps-drop span").empty();
             $("#ul-ps-drop span").append( "   "+ $("#ul-ps-3").text());
             ul_ps=String(parseInt(document.getElementById("st-size-ul").value)*1000000);
             alert(ul_ps);
         });
      ...
      $("#uldl-dl-ps-2").click(function(){
           $("#uldl-dl-ps-drop span").empty();
            ...
            uldl_dl_ps=String(parseInt(document.getElementById("st-size-uldl-dl").value)*1000);
            alert(uldl_dl_ps);
        });
      $("#uldl-dl-ps-3").click(function(){
             $("#dl-ps-drop span").empty();
             $("#dl-ps-drop span").append( "   "+ $("#uldl-dl-ps-3").text());
             uldl_dl_ps=String(parseInt(document.getElementById("st-size-uldl-dl").value)*1000000);
             alert(uldl_dl_ps);
      });
       ...
       $("#uldl-ul-ps-2").click(function(){
            $("#uldl-ul-ps-drop span").empty();
             ...
             uldl_ul_ps=String(parseInt(document.getElementById("st-size-uldl-ul").value)*1000);
             alert(uldl_ul_ps);
       });
       $("#uldl-ul-ps-3").click(function(){
              $("#uldl-ul-ps-drop span").empty();
              $("#uldl-ul-ps-drop span").append( "   "+ $("#uldl-ul-ps-3").text());
              uldl_ul_ps=String(parseInt(document.getElementById("st-size-uldl-ul").value)*1000000);
              alert(uldl_ul_ps);
      });
         ...
         $("#ul-tv-2").click(function(){
              $("#ul-tv-drop span").empty();
               ...
               ul_tv=String(parseInt(document.getElementById("st-volume-ul").value)*1000);
               alert(ul_tv);
           });
         $("#ul-tv-3").click(function(){
                $("#ul-tv-drop span").empty();
                $("#ul-tv-drop span").append( "   "+ $("#ul-tv-3").text());
                ul_tv=String(parseInt(document.getElementById("st-volume-ul").value)*1000000);
                alert(ul_tv);
            });
         $("#ul-tv-4").click(function(){
               $("#ul-tv-drop span").empty();
               $("#ul-tv-drop span").append( "   "+ $("#ul-tv-4").text());
               ul_tv=String(parseInt(document.getElementById("st-volume-ul").value)*1000000000);
               alert(ul_tv);
           });
         ...
         $("#dl-tv-2").click(function(){
              $("#dl-tv-drop span").empty();
               ...
               dl_tv=String(parseInt(document.getElementById("st-volume-dl").value)*1000);
               alert(dl_tv);
           });
         $("#dl-tv-3").click(function(){
                $("#dl-tv-drop span").empty();
                $("#dl-tv-drop span").append( "   "+ $("#dl-tv-3").text());
                dl_tv=String(parseInt(document.getElementById("st-volume-dl").value)*1000000);
                alert(dl_tv);
            });
         $("#dl-tv-4").click(function(){
               $("#dl-tv-drop span").empty();
               $("#dl-tv-drop span").append( "   "+ $("#dl-tv-4").text());
               dl_tv=String(parseInt(document.getElementById("st-volume-dl").value)*1000000000);
               alert(dl_tv);
           });
         ...
         $("#uldl-ul-tv-2").click(function(){
              $("#uldl-ul-tv-drop span").empty();
               ...
               uldl_ul_tv=String(parseInt(document.getElementById("st-volume-uldl-ul").value)*1000);
               alert(uldl_ul_tv);
           });
         $("#uldl-ul-tv-3").click(function(){
                $("#uldl-ul-tv-drop span").empty();
                $("#uldl-ul-tv-drop span").append( "   "+ $("#uldl-ul-tv-3").text());
                uldl_ul_tv=String(parseInt(document.getElementById("st-volume-uldl-ul").value)*1000000);
                alert(uldl_ul_tv);
            });
         $("#uldl-ul-tv-4").click(function(){
               $("#uldl-ul-tv-drop span").empty();
               $("#uldl-ul-tv-drop span").append( "   "+ $("#uldl-ul-tv-4").text());
               uldl_ul_tv=String(parseInt(document.getElementById("st-volume-uldl-ul").value)*1000000000);
               alert(uldl_ul_tv);
           });
         ...
         $("#uldl-dl-tv-2").click(function(){
              $("#uldl-dl-tv-drop span").empty();
               ...
               uldl_dl_tv=String(parseInt(document.getElementById("st-volume-uldl-dl").value)*1000);
               alert(uldl_dl_tv);
           });
         $("#uldl-dl-tv-3").click(function(){
                $("#uldl-dl-tv-drop span").empty();
                $("#uldl-dl-tv-drop span").append( "   "+ $("#uldl-dl-tv-3").text());
                uldl_dl_tv=String(parseInt(document.getElementById("st-volume-uldl-dl").value)*1000000);
                alert(uldl_dl_tv);
            });
         $("#uldl-dl-tv-4").click(function(){
               $("#uldl-dl-tv-drop span").empty();
               $("#uldl-dl-tv-drop span").append( "   "+ $("#uldl-dl-tv-4").text());
               uldl_dl_tv=String(parseInt(document.getElementById("st-volume-uldl-dl").value)*1000000000);
               alert(uldl_dl_tv);
           });
    ...
    if(st_type=="BOTH"){rand=rp_uldl_switch;}
